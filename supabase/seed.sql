...
Usage externe uniquement. Flacon pompe de 100 ml.', 0.5, 0, 'Normandie', 'Atelier du Bocage (fictif)', array['/products/huile-de-massage-chanvre.webp']::text[], '/coa/huile-de-massage-chanvre.pdf', array['cosmétique']::text[], true, false, '2026-01-10T00:00:00.000Z'),
  ...
  ('20000000-0000-4000-a000-00000000000c', 'grinder-bois-d-olivier', 'Grinder en bois d''olivier', '10000000-0000-4000-a000-000000000006', 'Tourné à la main dans du bois d''olivier, 2 parties.', 'Grinder 2 parties tourné dans du bois d''olivier, dents métalliques et couvercle aimanté. Chaque pièce est unique.', null, null, 'Provence-Alpes-Côte d''Azur', 'Tournerie des Alpilles (fictif)', array['/products/grinder-bois-d-olivier.webp']::text[], null, array['bois', 'artisanal']::text[], true, false, '2026-01-12T00:00:00.000Z'),
  ('20000000-0000-4000-a000-00000000000d', 'vaporisateur-portable-herbes-seches', 'Vaporisateur portable herbes sèches', '10000000-0000-4000-a000-000000000007', 'Chauffe par convection, 4 niveaux de température, USB-C.', 'Vaporisateur portable pour herbes sèches, chauffe par convection, chambre en céramique et 4 réglages de température (170 à 210 °C). Batterie rechargeable en USB-C. Garantie 2 ans.', null, null, null, null, array['/products/vaporisateur-portable-herbes-seches.webp']::text[], null, array['électronique']::text[], true, true, '2026-01-13T00:00:00.000Z'),
  ('20000000-0000-4000-a000-00000000000e', 'feuilles-slim-non-blanchies', 'Feuilles slim non blanchies + filtres', '10000000-0000-4000-a000-000000000008', 'Papier non blanchi, gomme arabique, carnet de filtres carton.', 'Carnet de 32 feuilles slim non blanchies avec 32 filtres en carton non blanchi.', null, null, null, null, array['/products/feuilles-slim-non-blanchies.webp']::text[], null, array['papier']::text[], true, false, '2026-01-14T00:00:00.000Z'),
  ('20000000-0000-4000-a000-00000000000f', 'bocal-verre-anti-uv', 'Bocal en verre anti-UV', '10000000-0000-4000-a000-000000000009', 'Verre violet filtrant les UV, couvercle à vis hermétique.', 'Bocal en verre violet qui filtre la lumière visible et UV pour préserver les arômes. Couvercle à vis hermétique.', null, null, null, null, array['/products/bocal-verre-anti-uv.webp']::text[], null, array['verre']::text[], true, false, '2026-01-15T00:00:00.000Z'),
  ('20000000-0000-4000-a000-000000000010', 'boite-conservation-bambou', 'Boîte de conservation en bambou', '10000000-0000-4000-a000-000000000009', 'Bambou et verre, compartiment aimanté.', 'Boîte en bambou avec couvercle aimanté, compartiment intérieur en verre et plateau de préparation amovible.', null, null, null, null, array['/products/boite-conservation-bambou.webp']::text[], null, array['bambou']::text[], true, false, '2026-01-16T00:00:00.000Z')
on conflict (id) do nothing;
