...
Conditionnée en sachet opaque refermable pour préserver ses arômes.', 11.5, 0.19, 'Provence-Alpes-Côte d''Azur', 'Les Champs de Lure (fictif)', array['/demo/fleur-amnesia-du-luberon.svg']::text[], '/coa/fleur-amnesia-du-luberon.pdf', array['plein champ', 'agrumes']::text[], true, true, '2026-01-01T00:00:00.000Z'),
...
Lire attentivement l''étiquette avant utilisation. Conserver à l''abri de la lumière et de la chaleur.', 10, 0.2, 'Nouvelle-Aquitaine', 'Huilerie du Périgord Vert (fictif)', array['/demo/huile-cbd-10-spectre-complet.svg']::text[], '/coa/huile-cbd-10-spectre-complet.pdf', array['bio', 'spectre complet']::text[], true, true, '2026-01-06T00:00:00.000Z'),
...
Lire attentivement l''étiquette avant utilisation.', 20, 0, 'Centre-Val de Loire', 'Domaine de la Sologne (fictif)', array['/demo/huile-cbd-20-spectre-large.svg']::text[], '/coa/huile-cbd-20-spectre-large.pdf', array['spectre large']::text[], true, false, '2026-01-07T00:00:00.000Z'),
...
Ingrédients : feuilles de chanvre, verveine, tilleul.', 1.5, 0.05, 'Auvergne-Rhône-Alpes', 'Jardins de la Drôme (fictif)', array['/demo/infusion-verveine-chanvre.svg']::text[], '/coa/infusion-verveine-chanvre.pdf', array['infusion', 'plantes']::text[], true, true, '2026-01-08T00:00:00.000Z'),
...
Usage externe uniquement. Éviter le contour des yeux. Pot en verre de 50 ml.', 1, 0, 'Provence-Alpes-Côte d''Azur', 'Savonnerie du Ventoux (fictif)', array['/demo/baume-corps-chanvre-lavande.svg']::text[], '/coa/baume-corps-chanvre-lavande.pdf', array['cosmétique', 'lavande']::text[], true, false, '2026-01-09T00:00:00.000Z'),
...
Usage externe uniquement. Flacon pompe de 100 ml.', 0.5, 0, 'Normandie', 'Atelier du Bocage (fictif)', array['/demo/huile-de-massage-chanvre.svg']::text[], '/coa/huile-de-massage-chanvre.pdf', array['cosmétique']::text[], true, false, '2026-01-10T00:00:00.000Z'),
  ('20000000-0000-4000-a000-00000000000b', 'grinder-aluminium-4-parties', 'Grinder aluminium 4 parties', '10000000-0000-4000-a000-000000000006', 'Aluminium anodisé, dents en losange, tamis à pollen.', 'Grinder en aluminium anodisé de 55 mm, 4 parties avec tamis inox et racloir inclus. Fermeture aimantée.', null, null, null, null, array['/demo/grinder-aluminium-4-parties.svg']::text[], null, array['aluminium']::text[], true, true, '2026-01-11T00:00:00.000Z'),
  ('20000000-0000-4000-a000-00000000000c', 'grinder-bois-d-olivier', 'Grinder en bois d''olivier', '10000000-0000-4000-a000-000000000006', 'Tourné à la main dans du bois d''olivier, 2 parties.', 'Grinder 2 parties tourné dans du bois d''olivier, dents métalliques et couvercle aimanté. Chaque pièce est unique.', null, null, 'Provence-Alpes-Côte d''Azur', 'Tournerie des Alpilles (fictif)', array['/demo/grinder-bois-d-olivier.svg']::text[], null, array['bois', 'artisanal']::text[], true, false, '2026-01-12T00:00:00.000Z'),
  ('20000000-0000-4000-a000-00000000000d', 'vaporisateur-portable-herbes-seches', 'Vaporisateur portable herbes sèches', '10000000-0000-4000-a000-000000000007', 'Chauffe par convection, 4 niveaux de température, USB-C.', 'Vaporisateur portable pour herbes sèches, chauffe par convection, chambre en céramique et 4 réglages de température (170 à 210 °C). Batterie rechargeable en USB-C. Garantie 2 ans.', null, null, null, null, array['/demo/vaporisateur-portable-herbes-seches.svg']::text[], null, array['électronique']::text[], true, true, '2026-01-13T00:00:00.000Z'),
  ('20000000-0000-4000-a000-00000000000e', 'feuilles-slim-non-blanchies', 'Feuilles slim non blanchies + filtres', '10000000-0000-4000-a000-000000000008', 'Papier non blanchi, gomme arabique, carnet de filtres carton.', 'Carnet de 32 feuilles slim non blanchies avec 32 filtres en carton non blanchi.', null, null, null, null, array['/demo/feuilles-slim-non-blanchies.svg']::text[], null, array['papier']::text[], true, false, '2026-01-14T00:00:00.000Z'),
  ('20000000-0000-4000-a000-00000000000f', 'bocal-verre-anti-uv', 'Bocal en verre anti-UV', '10000000-0000-4000-a000-000000000009', 'Verre violet filtrant les UV, couvercle à vis hermétique.', 'Bocal en verre violet qui filtre la lumière visible et UV pour préserver les arômes. Couvercle à vis hermétique.', null, null, null, null, array['/demo/bocal-verre-anti-uv.svg']::text[], null, array['verre']::text[], true, false, '2026-01-15T00:00:00.000Z'),
  ('20000000-0000-4000-a000-000000000010', 'boite-conservation-bambou', 'Boîte de conservation en bambou', '10000000-0000-4000-a000-000000000009', 'Bambou et verre, compartiment aimanté.', 'Boîte en bambou avec couvercle aimanté, compartiment intérieur en verre et plateau de préparation amovible.', null, null, null, null, array['/demo/boite-conservation-bambou.svg']::text[], null, array['bambou']::text[], true, false, '2026-01-16T00:00:00.000Z')
on conflict (id) do nothing;

insert into public.product_variants (id, product_id, label, price_cents, stock, sku, position) values
  ('30000000-0000-4000-a000-000000000001', '20000000-0000-4000-a000-000000000001', '2 g', 1400, 40, 'AH-0001', 0),
  ...
  ('30000000-0000-4000-a000-000000000004', '20000000-0000-4000-a000-000000000002', '2 g', 1600, 30, 'AH-0004', 0),
  ...
  ('30000000-0000-4000-a000-000000000007', '20000000-0000-4000-a000-000000000003', '2 g', 1300, 50, 'AH-0007', 0),
  ('30000000-0000-4000-a000-000000000008', '20000000-0000-4000-a000-000000000003', '5 g', 2900, 30, 'AH-0008', 1),
  ('30000000-0000-4000-a000-000000000009', '20000000-0000-4000-a000-000000000004', '1 g', 1100, 40, 'AH-0009', 0),
  ('30000000-0000-4000-a000-00000000000a', '20000000-0000-4000-a000-000000000004', '3 g', 3000, 25, 'AH-0010', 1),
  ('30000000-0000-4000-a000-00000000000b', '20000000-0000-4000-a000-000000000004', '5 g', 4600, 10, 'AH-0011', 2),
  ('30000000-0000-4000-a000-00000000000c', '20000000-0000-4000-a000-000000000005', '1 g', 1400, 25, 'AH-0012', 0),
  ('30000000-0000-4000-a000-00000000000d', '20000000-0000-4000-a000-000000000005', '3 g', 3900, 12, 'AH-0013', 1),
  ('30000000-0000-4000-a000-00000000000e', '20000000-0000-4000-a000-000000000006', '10 ml', 3900, 35, 'AH-0014', 0),
  ('30000000-0000-4000-a000-00000000000f', '20000000-0000-4000-a000-000000000006', '30 ml', 9900, 15, 'AH-0015', 1),
  ('30000000-0000-4000-a000-000000000010', '20000000-0000-4000-a000-000000000007', '10 ml', 6900, 20, 'AH-0016', 0),
  ('30000000-0000-4000-a000-000000000011', '20000000-0000-4000-a000-000000000008', '30 g', 1200, 60, 'AH-0017', 0),
  ('30000000-0000-4000-a000-000000000012', '20000000-0000-4000-a000-000000000008', '80 g', 2800, 25, 'AH-0018', 1),
  ('30000000-0000-4000-a000-000000000013', '20000000-0000-4000-a000-000000000009', '50 ml', 2400, 30, 'AH-0019', 0),
  ('30000000-0000-4000-a000-000000000014', '20000000-0000-4000-a000-00000000000a', '100 ml', 2900, 20, 'AH-0020', 0),
  ('30000000-0000-4000-a000-000000000015', '20000000-0000-4000-a000-00000000000b', 'Vert sauge', 2200, 20, 'AH-0021', 0),
  ('30000000-0000-4000-a000-000000000016', '20000000-0000-4000-a000-00000000000b', 'Noir', 2200, 15, 'AH-0022', 1),
  ('30000000-0000-4000-a000-000000000017', '20000000-0000-4000-a000-00000000000c', 'Ø 50 mm', 3400, 8, 'AH-0023', 0),
  ('30000000-0000-4000-a000-000000000018', '20000000-0000-4000-a000-00000000000d', 'Graphite', 11900, 10, 'AH-0024', 0),
  ('30000000-0000-4000-a000-000000000019', '20000000-0000-4000-a000-00000000000e', '1 carnet', 250, 200, 'AH-0025', 0),
  ('30000000-0000-4000-a000-00000000001a', '20000000-0000-4000-a000-00000000000e', 'Boîte de 24', 4800, 20, 'AH-0026', 1),
  ('30000000-0000-4000-a000-00000000001b', '20000000-0000-4000-a000-00000000000f', '100 ml', 1500, 30, 'AH-0027', 0),
  ('30000000-0000-4000-a000-00000000001c', '20000000-0000-4000-a000-00000000000f', '250 ml', 2100, 20, 'AH-0028', 1),
  ('30000000-0000-4000-a000-00000000001d', '20000000-0000-4000-a000-000000000010', 'Taille unique', 2900, 12, 'AH-0029', 0)
on conflict (id) do nothing;
