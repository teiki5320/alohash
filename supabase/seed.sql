...
Conditionnée en sachet opaque refermable pour préserver ses arômes.', 11.5, 0.19, 'Provence-Alpes-Côte d''Azur', 'Les Champs de Lure (fictif)', array['/products/fleur-amnesia-du-luberon.webp']::text[], '/coa/fleur-amnesia-du-luberon.pdf', array['plein champ', 'agrumes']::text[], true, true, '2026-01-01T00:00:00.000Z'),
...
Lire attentivement l''étiquette avant utilisation. Conserver à l''abri de la lumière et de la chaleur.', 10, 0.2, 'Nouvelle-Aquitaine', 'Huilerie du Périgord Vert (fictif)', array['/products/huile-cbd-10-spectre-complet.webp']::text[], '/coa/huile-cbd-10-spectre-complet.pdf', array['bio', 'spectre complet']::text[], true, true, '2026-01-06T00:00:00.000Z'),
...
Lire attentivement l''étiquette avant utilisation.', 20, 0, 'Centre-Val de Loire', 'Domaine de la Sologne (fictif)', array['/products/huile-cbd-20-spectre-large.webp']::text[], '/coa/huile-cbd-20-spectre-large.pdf', array['spectre large']::text[], true, false, '2026-01-07T00:00:00.000Z'),
...
Ingrédients : feuilles de chanvre, verveine, tilleul.', 1.5, 0.05, 'Auvergne-Rhône-Alpes', 'Jardins de la Drôme (fictif)', array['/products/infusion-verveine-chanvre.webp']::text[], '/coa/infusion-verveine-chanvre.pdf', array['infusion', 'plantes']::text[], true, true, '2026-01-08T00:00:00.000Z'),
...
Usage externe uniquement. Éviter le contour des yeux. Pot en verre de 50 ml.', 1, 0, 'Provence-Alpes-Côte d''Azur', 'Savonnerie du Ventoux (fictif)', array['/products/baume-corps-chanvre-lavande.webp']::text[], '/coa/baume-corps-chanvre-lavande.pdf', array['cosmétique', 'lavande']::text[], true, false, '2026-01-09T00:00:00.000Z'),
